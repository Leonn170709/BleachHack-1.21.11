...
// Ported from Minecraft 1.19.4's shaders/program/blobs2.fsh (Mojang). Radius was a live uniform
// there; baked as a const here since 1.21.11 post-effect uniforms are read once at load, not
// per-frame (see entity_outline_meteor.fsh for the same tradeoff).
