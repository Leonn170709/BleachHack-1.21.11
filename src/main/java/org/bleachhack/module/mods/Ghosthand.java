...
public class Ghosthand extends Module {
	...
	public void onTick(EventTick event) {
		...
		BlockPos lookingPos = BlockPos.ofFloored(mc.player.raycast(4.25, mc.getRenderTickCounter().getTickProgress(true), false).getPos());
		...
		for (int i = 1; i < 50; i++) {
			BlockPos curPos = BlockPos.ofFloored(mc.player.getCameraPosVec(mc.getRenderTickCounter().getTickProgress(true)).add(nextPos.multiply(i)));
